...
function verwerkTaken(result) {
	...
	for (var i = 0; i < taken.length; i++) {
		$("#C" + taken[i].CATID).append("<fieldset id=T" + taken[i].TAAKID + " ><legend><i class='fas fa-clipboard'></i> " + taken[i].TITEL +"</legend><div class='edit fas fa-pencil-alt' onmouseenter='gaint(" + taken[i].TAAKID +")' onmouseleave='gauitt(" + taken[i].TAAKID + ")'></div><sub>Start:" +(taken[i].STARTDAT)+ " Einde:" +taken[i].EINDDAT+"</sub><p>" + taken[i].TAAKOMSCHR + "</p>" + "</fieldset>");
	}
}
