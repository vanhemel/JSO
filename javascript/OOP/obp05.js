...
console.log("Na %d:%s u gereden te hebben tegen %d km/uur heb je %d km afgelegd",
 ...
 console.log( auto["aantalUren"]);

 for(var smurf in auto){
    console.log("propertie %s heeft waarde %s", smurf, auto[smurf]);
 }

 delete auto.snelheid;
 console.log(auto);

 console.log(auto.smurf);
 if (auto.smurf != undefined){
     // auto heeft propery smurf
 }
